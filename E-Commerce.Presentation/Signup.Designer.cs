namespace E_Commerce.Presentation
{
    partial class Signup
    {
        ...
        private void InitializeComponent()
        {
            ...
            signup_firstName = new Guna.UI2.WinForms.Guna2TextBox();
            lblLastName = new Label();
            signup_lastName = new Guna.UI2.WinForms.Guna2TextBox();
            lblUsername = new Label();
            signup_username = new Guna.UI2.WinForms.Guna2TextBox();
            lblEmail = new Label();
            signup_email = new Guna.UI2.WinForms.Guna2TextBox();
            lblPassword = new Label();
            signup_password = new Guna.UI2.WinForms.Guna2TextBox();
            lblConfirmPassword = new Label();
            signup_confirmpassword = new Guna.UI2.WinForms.Guna2TextBox();
        ...
        private Guna.UI2.WinForms.Guna2TextBox signup_firstName;
        private System.Windows.Forms.Label lblLastName;
        private Guna.UI2.WinForms.Guna2TextBox signup_lastName;
        ...
        private Guna.UI2.WinForms.Guna2TextBox signup_confirmpassword;
